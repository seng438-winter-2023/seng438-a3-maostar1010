...
public class CalculateColumnTotalTests {
	...
	public static class CalculateColumnTotal_invalidColumnTests {
		...
		public void calculateColumnTotal_negativeIndex() {
			double result = DataUtilities.calculateColumnTotal(this.valuesToTest, -1);
			assertEquals("Testing a negative column value", 0.0, result, 0.00001d);
		}
		
		@Test
		public void calculateColumnTotal_biggerIndex() {
			double result = DataUtilities.calculateColumnTotal(this.valuesToTest, 2);
			assertEquals("Testing a column value that is longer than the length of Values2D", 0.0, result, 0.00001d);
		}
	}
}
